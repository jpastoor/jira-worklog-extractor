...
use Jpastoor\JiraWorklogExtractor\Command\ReworkCommand;
...
use Jpastoor\JiraWorklogExtractor\Command\WorkedHoursPerTicketPerAuthorCommand;
...
$application->add(new WorkedHoursPerTicketPerAuthorCommand());
$application->add(new ClearCacheCommand());
$application->add(new ReworkCommand());
$application->run();
